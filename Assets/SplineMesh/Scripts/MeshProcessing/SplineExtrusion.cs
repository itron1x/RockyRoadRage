...
namespace SplineMesh {
    ...
    public class SplineExtrusion : MonoBehaviour {
        ...
        public float sampleSpacing = 0.001f;
        ...
        private void Reset() {
            shapeVertices.Clear();
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(-0.035f, 0.005f), Vector2.up, 0)); // Oben Links
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(0.035f, 0.005f), Vector2.up, 0.33f)); // Oben Rechts
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(0.035f, -0.005f), Vector2.down, 0.66f)); // Unten Rechts
            shapeVertices.Add(new ExtrusionSegment.Vertex(new Vector2(-0.035f, -0.005f), Vector2.down, 1)); // Unten Links
            toUpdate = true;
            OnEnable();
        }
